...
<td width="100"><input type="image" src="./imgsource/link.png" onclick="lolname()" class="j" width=50 height=auto></td>
</tr>
<tr bordercolor="skyblue" align=center height=50>
<td width="100">+1</td>
...
<td>2</td>	
<td>스마트컨텐츠과</td>
<td width="100"><input type="image" src="./imgsource/link.png" class="j" width=50 height=auto></td>
</tr>
<tr bordercolor="skyblue" align=center height=50>
<td width="100">-2</td>
